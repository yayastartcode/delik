        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
              ...
              <ol className="space-y-3 text-gray-700 list-decimal list-inside">
                <li className="leading-relaxed">
                  Memberikan pendampingan hukum kepada masyarakat yang
                  membutuhkan.
                </li>
                <li className="leading-relaxed">
                  Melakukan edukasi hukum dan advokasi terhadap pelanggaran
                  hak-hak warga negara.
                </li>
                <li className="leading-relaxed">
                  Melakukan koordinasi dengan lembaga penegak hukum sesuai
                  kebutuhan penanganan kasus.
                </li>
              </ol>
            </div>
            ...
            <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
              ...
              <ol className="space-y-3 text-gray-700 list-decimal list-inside">
                <li className="leading-relaxed">
                  Melaksanakan aksi sosial, bantuan darurat, dan respon cepat
                  bencana.
                </li>
                <li className="leading-relaxed">
                  Menjalin kolaborasi dengan lembaga kemanusiaan pemerintah dan
                  non-pemerintah.
                </li>
              </ol>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
              ...
              <ol className="space-y-3 text-gray-700 list-decimal list-inside">
                <li className="leading-relaxed">
                  Membantu kegiatan sosial masyarakat seperti pembinaan
                  komunitas, pemberdayaan, dan kegiatan kepedulian sosial
                  lainnya.
                </li>
                <li className="leading-relaxed">
                  Melakukan pemetaan kebutuhan sosial masyarakat di wilayah
                  tugasnya.
                </li>
              </ol>
            </div>
